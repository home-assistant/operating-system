...
function create_platform_conf () {
    {
      ...
      echo "DDRLoad:0xd9000000"
      echo "DDRRun:0xd9000000"
      echo "UbootLoad:0x200c000"
      echo "UbootRun:0xd9000000"
      echo "Control0=0xd9000000:0x000000b1"
      echo "Control1=0xd9000000:0x00005183"
      echo "Encrypt_reg:0xc8100228"
      echo "bl2ParaAddr=0xd900c000"
